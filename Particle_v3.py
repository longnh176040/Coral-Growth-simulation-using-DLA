...
class Particle:
    def __init__(self, x_max, y_max, z_max, env, seed):
        if seed:
            self.x1 = rd.randrange(10, x_max-10)
            self.y1 = rd.randrange(10, y_max-10)
            self.z1 = 0
            self.stat = seed
        else:
